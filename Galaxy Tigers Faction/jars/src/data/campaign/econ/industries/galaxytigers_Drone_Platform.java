...
public class galaxytigers_Drone_Platform extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {

    @Override
    public boolean isHidden() {
        return !market.getFactionId().equals("galaxytigers");
    }

    @Override
    public boolean isFunctional() {
        return super.isFunctional() && market.getFactionId().equals("galaxytigers");
    }
    ...
    public String getNameForModifier() {
        if (getSpec().getName().contains("Platform")) {
    ...
    protected IntervalUtil tracker = new IntervalUtil(Global.getSettings().getFloat("averagePatrolSpawnInterval") * 0.6f,
            Global.getSettings().getFloat("averagePatrolSpawnInterval") * 1f);
    ...
    public void advance(float amount) {
        ...
        if (tracker.intervalElapsed()) {
            ...
            float patrolDays = 40f + (float) Math.random() * 10f;
    ...
    public CampaignFleetAPI spawnFleet(RouteData route) {
        ...
        switch (type) {
            ...
            case COMBAT:
                ...
                break;
            case HEAVY:
                combat = Math.round(15f + (float) random.nextFloat() * 5f) * 5f;
        ...
        FleetParamsV3 params = new FleetParamsV3(
                ...
                "galaxytigers_drone_guard", // faction id
        ...
        fleet.getCommander().addTag("galaxytigers_ai_commander");
...
//		fleet.addScript(ai);
    ...
    public String getRouteSourceId() {
        return getMarket().getId() + "_" + "galaxytigers_drone";
    }
